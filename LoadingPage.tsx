...
import "./components/loading-page.css";
...
export default function LoadingPage({
  ...
  function draw(pct: number) {
    ...
    // 2. Water shape on temp canvas, masked to text glyphs
  ...
  return (
    <div className="nl-loader">
      <div
        className={`nl-stage${explode ? " goo-out" : ""}`}
        ref={stageRef}
      >
        <canvas
          ref={canvasRef}
